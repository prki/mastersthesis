...
resolution on desktop devices \emph{[CITATION NEEDED http://gs.statcounter.com/screen-resolution-stats/desktop/worldwide]}.
...
sharing had over 67 million new posts each day \emph{[CITATION NEEDED https://blog.microfocus.com/how-much-data-is-created-on-the-internet-each-day/]}.
...
algorithms aim to reduce the number of random variables under consideration\emph{[CITATION NEEDED http://www.robots.ox.ac.uk/~az/lectures/ml/lle.pdf]}.
\\
...
which has been well researched is the \emph{singular value decomposition} algorithm, for example in [\emph{CITATION NEEDED see SVD link nahore}]. This algorithm, just like the \emph{NMF}, factorizes a matrix - however, without
