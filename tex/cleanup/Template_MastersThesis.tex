...
The images chosen from the set are shown, together with their names, on the figure \ref{fig:benchmarkimages}.

%\begin{figure}[h]
%  \centering
%  \includegraphics{imgs/benchmarkimages}
%  \caption{Images used in the experiments.}
