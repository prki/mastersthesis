...
\subsection{Black squares in white space}
% random naive rgb redundancies obrazek - okraje
...
the image has had white borders surround the image. These borders were full
of artifacts in the form of black regions. This occured only when the
method of seeding initial factor matrices using a random method. When the
NNDSVD method was used, no black squares were found in the image. The
effect can be seen in the figure \ref{fig:blacksquares}. This further shows
that random initialization can be very harmful for compressing images using
