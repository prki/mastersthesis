...
matrices, these factors are flattened and afterwards concatenated, resulting
in one long string of bytes which is afterwards compressed using a lossless
algorithm of choice (more on the specifics of implementation in the following chapter).
=======
>>>>>>> d6172b690c6f2796a0eb208cebb2d9d6565232a1
...
After factorizing the matrices containing the chroma components, all 5 matrices will
be flattened and concatenated. This data will then be compressed using a lossless
technique of choice.
...
% Je zde pojem non-deterministic OK?
